...
func makeRequest(endpoint string, body *bytes.Buffer, headers map[string]string) (map[string]interface{}, string) {
...
func upload(files []string) {
	...
	respBody, status := makeRequest(endpoint, gistJSON, headers)
